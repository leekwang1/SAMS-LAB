...
class MainWindow(QMainWindow):
    ...
    def _create_slice_dock(self):
        ...
        self._chk_five_circle_radial_preprocess = QCheckBox("전처리 Radial")
        self._chk_five_circle_radial_preprocess.setChecked(False)
        five_circle_layout.addWidget(self._chk_five_circle_radial_preprocess)
        ...
        self._chk_five_circle_radial_preprocess.hide()
        five_radial_layout = QHBoxLayout()
        self._label_five_radial_bins = QLabel("Bins:")
        self._spin_five_radial_bins = QDoubleSpinBox()
        self._spin_five_radial_bins.setRange(36, 3600)
        self._spin_five_radial_bins.setValue(3600)
        self._spin_five_radial_bins.setSingleStep(36)
        self._spin_five_radial_bins.setDecimals(0)
        self._chk_five_radial_min_radius = QCheckBox("최소 반경")
        self._chk_five_radial_min_radius.setChecked(True)
        self._edit_five_radial_min_radius = QLineEdit("1.0")
        self._edit_five_radial_min_radius.setValidator(QDoubleValidator(0.0, 10000.0, 3, self))
        self._edit_five_radial_min_radius.setFixedWidth(64)
        self._edit_five_radial_min_radius.setEnabled(True)
        self._chk_five_radial_min_radius.toggled.connect(self._on_five_circle_radial_preprocess_toggled)
        self._label_five_radial_min_radius_unit = QLabel("m")
        five_radial_layout.addWidget(self._label_five_radial_bins)
        five_radial_layout.addWidget(self._spin_five_radial_bins)
        five_radial_layout.addWidget(self._chk_five_radial_min_radius)
        five_radial_layout.addWidget(self._edit_five_radial_min_radius)
        five_radial_layout.addWidget(self._label_five_radial_min_radius_unit)
        five_radial_layout.addStretch(1)
        layout.addLayout(five_radial_layout)
        self._label_five_radial_bins.hide()
        self._spin_five_radial_bins.hide()
        self._chk_five_radial_min_radius.hide()
        self._edit_five_radial_min_radius.hide()
        self._label_five_radial_min_radius_unit.hide()
        five_radial_midline_layout = QHBoxLayout()
        self._chk_five_radial_midline = QCheckBox("Midline")
        self._chk_five_radial_midline.setChecked(True)
        self._spin_five_radial_midline_outer = QDoubleSpinBox()
        self._spin_five_radial_midline_outer.setRange(55.0, 99.5)
        self._spin_five_radial_midline_outer.setValue(90.0)
        self._spin_five_radial_midline_outer.setSingleStep(0.5)
        self._spin_five_radial_midline_outer.setDecimals(1)
        self._spin_five_radial_midline_outer.setSuffix(" %")
        self._spin_five_radial_midline_outer.setEnabled(True)
        self._chk_five_radial_midline.toggled.connect(self._on_five_circle_radial_preprocess_toggled)
        five_radial_midline_layout.addWidget(self._chk_five_radial_midline)
        five_radial_midline_layout.addWidget(self._spin_five_radial_midline_outer)
        five_radial_midline_layout.addStretch(1)
        layout.addLayout(five_radial_midline_layout)
        self._chk_five_radial_midline.hide()
        self._spin_five_radial_midline_outer.hide()
        self._chk_five_circle_radial_preprocess.toggled.connect(self._on_five_circle_radial_preprocess_toggled)
    ...
    def _on_radial_midline_toggled(self, checked):
        ...
        if checked and self._chk_radial_percentile.isChecked():
            self._chk_radial_percentile.setChecked(False)
    def _on_five_circle_radial_preprocess_toggled(self, checked=None):
        checked = self._chk_five_circle_radial_preprocess.isChecked()
        self._label_five_radial_bins.setEnabled(checked)
        self._spin_five_radial_bins.setEnabled(checked)
        self._chk_five_radial_min_radius.setEnabled(checked)
        self._edit_five_radial_min_radius.setEnabled(checked and self._chk_five_radial_min_radius.isChecked())
        self._label_five_radial_min_radius_unit.setEnabled(checked)
        self._chk_five_radial_midline.setEnabled(checked)
        self._spin_five_radial_midline_outer.setEnabled(checked and self._chk_five_radial_midline.isChecked())
    ...
    def _on_contour_method_changed(self, index):
        ...
        if method == 'concave':
            ...
            self._contour_param_spin.setRange(36, 3600)
            ...
            self._chk_five_circle_radial_preprocess.show()
            self._label_five_radial_bins.show()
            self._spin_five_radial_bins.show()
            self._chk_five_radial_min_radius.show()
            self._edit_five_radial_min_radius.show()
            self._label_five_radial_min_radius_unit.show()
            self._chk_five_radial_midline.show()
            self._spin_five_radial_midline_outer.show()
            self._on_five_circle_radial_preprocess_toggled(self._chk_five_circle_radial_preprocess.isChecked())
        elif method == 'circle':
    ...
    def _get_contour_kwargs(self, method):
        ...
        if method == 'concave':
            ...
            kwargs['preprocess_radial'] = self._chk_five_circle_radial_preprocess.isChecked()
            kwargs['preprocess_radial_bins'] = int(self._spin_five_radial_bins.value())
            if self._chk_five_radial_min_radius.isChecked():
                try:
                    min_radius = float(self._edit_five_radial_min_radius.text())
                except ValueError:
                    min_radius = 1.0
                    self._edit_five_radial_min_radius.setText("1.0")
                kwargs['preprocess_radial_min_radius'] = max(0.0, min_radius)
            else:
                kwargs['preprocess_radial_min_radius'] = 0.0
            kwargs['preprocess_radial_midline'] = self._chk_five_radial_midline.isChecked()
            kwargs['preprocess_radial_outer_percentile'] = self._spin_five_radial_midline_outer.value()
        elif method == 'circle':
